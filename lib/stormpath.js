...
function updateAccount(account, data) {
  ...
  for (var key in data) {
    if (key !== 'password' && standardFields.indexOf(key) === -1) {
 ...
 * TODO: query clause
 */
Stormpath.prototype.find = function(model, query, callback) {
  // Allow this to run with no query specified.
 ...
 */
//Stormpath.prototype.update =
//  Stormpath.prototype.updateAll = function updateAll(model, where, data, cb) {
//    var self = this;
//    if (self.debug) {
